...
public class Frame_DoiTac_NhaCungCap extends JPanel {
	...
	// Cập nhật dữ liệu vào table
		...
		private void btnThemActionPerformed() throws ParseException {
			...
			if (error != null) {
				JOptionPane.showMessageDialog(Frame_DoiTac_NhaCungCap.this, "Error: " + error);
			...
			if (isDuplicateEmail(email, mancc)) {
				JOptionPane.showMessageDialog(Frame_DoiTac_NhaCungCap.this,
...
//				lockFields();
	...
	public Frame_DoiTac_NhaCungCap() {
		setLayout(null);
		...
		btnSua.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\edit.png"));
		...
		btnLuu.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\save.png"));
		...
		btnHuy.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\cancel.png"));
		...
		btnXuat.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\print.png"));
		...
		btnThem.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\add.png"));
		...
		btnNgungHopTac.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\layoff.png"));
		...
		btnHopTacLai.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\back_job.png"));
		...
		btnTim.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\find.png"));
		...
		btnTaiLai.setIcon(new ImageIcon("D:\\WorkSpaceHSK\\Pharmacy_Management_Application\\icon\\refresh.png"));

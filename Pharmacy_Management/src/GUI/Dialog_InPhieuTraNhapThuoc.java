...
public class Dialog_InPhieuTraNhapThuoc extends JDialog {
	...
	public Dialog_InPhieuTraNhapThuoc(JFrame parent, String maTNT, String ngayLap, double tongTien, String maNV,
			String maNCC, String trangThaiStr, String phuongThucThanhToanStr, java.util.List<Object[]> chiTietList) {
		super(parent, "Hóa Đơn - " + maTNT, true);
		...
		// Tiêu đề hóa đơn
		JLabel lblTieuDe = new JLabel("HÓA ĐƠN PHIẾU TRẢ NHẬP THUỐC");
	    ...
	    // Format the amount
	    String formattedAmount = currencyFormatter.format(tongTien);
		JLabel txtTongTien = new JLabel(formattedAmount);

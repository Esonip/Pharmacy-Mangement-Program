...
public class Frame_GiaoDich_HoaDon extends JPanel {
	...
	private void btnXoaAction() {
		...
		if (row == -1) {
			JOptionPane.showMessageDialog(Frame_GiaoDich_HoaDon.this, "Vui lòng chọn hóa đơn cần xóa!");
			return;
		}

		int confirm = JOptionPane.showConfirmDialog(Frame_GiaoDich_HoaDon.this,
	...
	private void btnInHoaDonAction() {
		...
		int row = tableDSHD.getSelectedRow();
		if (row == -1) {
			JOptionPane.showMessageDialog(Frame_GiaoDich_HoaDon.this, "Vui lòng chọn hóa đơn cần in!");
			return;
		}

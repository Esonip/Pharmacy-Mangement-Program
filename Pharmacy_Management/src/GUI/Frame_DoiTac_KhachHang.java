...
public class Frame_DoiTac_KhachHang extends JPanel {
...
//	private boolean isEditting = false;
	...
	private void btnThemAction() throws ParseException {
		...
		if (error != null) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Lỗi! " + error);
		...
		if (khachHangDAO.isDuplicateDienThoai(dienThoai, maKH)) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Số điện thoại đã tồn tại!");
			txtDienThoai.requestFocus();
			return;
		}

		if (khachHangDAO.isDuplicateEmail(email, maKH)) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Email đã tồn tại!");
			txtEmail.requestFocus();
			return;
		}
		...
		if (ngaySinh == null) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this,
	...
	private void btnLuuAction() throws ParseException {
		int selectedRow = tableKhachHang.getSelectedRow();
		if (selectedRow == -1) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Vui lòng chọn khách hàng cần sửa để lưu!");
			return;
		}
	...
	private void btnXoaAction() {
		int selectedRow = tableKhachHang.getSelectedRow();
		if (selectedRow == -1) {
			JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Vui lòng chọn khách hàng để xóa!");
			return;
		}

		int confirm = JOptionPane.showConfirmDialog(Frame_DoiTac_KhachHang.this,
...
//		isEditting = false;
	...
	private String generateNextMaKhachHang() {
	    ...
	    if (lastMaKH == null || lastMaKH.isEmpty() || lastMaKH.equals("KH000")) {
	        return "KH1";
	    }
		...
		tableKhachHang.addMouseListener(new java.awt.event.MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					e1.printStackTrace();
					JOptionPane.showMessageDialog(Frame_DoiTac_KhachHang.this, "Lỗi định dạng ngày sinh: ");
				}

...
public class Frame_HoaDon_DanhSachHoaDon extends JPanel {
	...
	private void btnXoaAction() {
		...
		if (row == -1) {
			JOptionPane.showMessageDialog(Frame_HoaDon_DanhSachHoaDon.this, "Vui lòng chọn hóa đơn cần xóa!");
			return;
		}

		int confirm = JOptionPane.showConfirmDialog(Frame_HoaDon_DanhSachHoaDon.this,
	...
	private void btnInHoaDonAction() {
		...
		int row = tableDSHD.getSelectedRow();
		if (row == -1) {
			JOptionPane.showMessageDialog(Frame_HoaDon_DanhSachHoaDon.this, "Vui lòng chọn hóa đơn cần in!");
			return;
		}
	...
	public Frame_HoaDon_DanhSachHoaDon() {
		setLayout(null);

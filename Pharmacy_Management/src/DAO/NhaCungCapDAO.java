...
public class NhaCungCapDAO {
	public List<Object[]> loadDataToTable(Boolean trangThai) {
        ...
        try (Connection conn = ConnectDB.getConnection("DB_QuanLyNhaThuoc");
             PreparedStatement stmt = conn.prepareStatement(
            		 "SELECT ncc.maNCC, ncc.tenNCC, ncc.diaChi, ncc.soDienThoai, ncc.email " +
                             "FROM NhaCungCap ncc " +
                             "WHERE ncc.trangThai = ?")) {
            ...
            while (rs.next()) {
                Object[] row = { rs.getString("maNCC"), rs.getString("tenNCC"), 
	...
	public void saveNhaCungCap(boolean isEditing, String maNCC, String tenNCC, String diaChi, String soDienThoai, String email) throws ParseException {
        try (Connection conn = ConnectDB.getConnection("DB_QuanLyNhaThuoc")) {
            String sql;
